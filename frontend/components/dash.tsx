...
//               <th className="p-1 min-w-[60px]">%ACHIEVEMENT</th>
      ...
      .then((data) => {
        if (data.success) {
          ...
          if (targetEndDate) {
            ...
            const diffWeeks = Math.max(Math.ceil(diffMs / (1000 * 60 * 60 * 24 * 7)), 0);
            ...
            <div>
              ...
              <p className="text-sm md:text-base text-gray-200 mt-1">
                ...
                {summary?.Mission?.endDate
                  ? new Date(summary.Mission.endDate).toLocaleDateString("en-US", {
                      month: "long",
                      day: "numeric",
                    })
                  : "-"}{" "}
